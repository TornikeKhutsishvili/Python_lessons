...
# დააბრუნე dictionary. მაგალითად: "Python is fun" → {"Python": 6, "is": 2, "fun": 3}

def word_length(sentence):
    words = sentence.split() # წინადადების სიტყვებად დაყოფა
    result = {} # ცარიელი dictionary

    # თითოეული სიტყვის გადავლა
    for word in words:
        # key = სიტყვა და value = სიტყვის სიგრძე
        result[word] = len(word)
        # print(word, len(word))

    return result

res_word_length = word_length("Python is fun")
print(res_word_length)
